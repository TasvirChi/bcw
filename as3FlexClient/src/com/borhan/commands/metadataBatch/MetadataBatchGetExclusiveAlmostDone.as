package com.borhan.commands.metadataBatch
{
	...
	public class MetadataBatchGetExclusiveAlmostDone extends BorhanCall
	{
		...
		public function MetadataBatchGetExclusiveAlmostDone( lockKey : BorhanExclusiveLockKey,maxExecutionTime : int,numberOfJobs : int,filter : BorhanBatchJobFilter=null,jobType : int )
		{
