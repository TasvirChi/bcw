...
package com.borhan.contributionWizard.command
{
	...
	import com.borhan.contributionWizard.business.FileUploadDelegate;
	import com.borhan.contributionWizard.events.ReportErrorEvent;
	import com.borhan.contributionWizard.model.UploadModelLocator;
	import com.borhan.contributionWizard.model.WizardModelLocator;
	import com.borhan.contributionWizard.model.importData.UploadCartStatusTypes;
	...
	public class UploadFilesCommand implements ICommand, IResponder
	{
		...
		private function uploadSingleFile(importFileVo:ImportFileVO):void
		{
			...
			uploadToken.addEventListener(BorhanEvent.COMPLETE, uploadTokenHandler);
		 ...
		 * 
		 */		
		private function uploadTokenHandler(event:BorhanEvent):void {
			
			var tokenId:String = BorhanUploadToken(event.data).id;
